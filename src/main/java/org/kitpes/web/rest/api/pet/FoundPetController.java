...
public class FoundPetController {
    ...
    public List<FoundPet> petsLimited(@RequestParam(value = "type") int type,
    ...
    public Collection<FoundPet> pets() {
        return repository.getAll();
    }

    @RequestMapping(value = "{id}", method = GET)
    public FoundPet pet(@PathVariable long id) {
    ...
    public ResponseEntity create(@RequestPart(required = false, value = "profilePicture") MultipartFile file,
        ...
        if (dateLostFound != null) {
            pet.setDateFound(dateLostFound);
        }
