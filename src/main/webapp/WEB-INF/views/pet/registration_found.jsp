            ...
            <div class="c-form__block">
                <div class="c-form__photo-block">
                    ...
                    <div class="l-wrap">
                        ...
                        <label for="file5">
                            <div class="c-form__photo-upload"><img class="c-form__uploud-icon" src="/resources/registration_found/images/upload.svg"></div>
                        </label>
                ...
                <form class="c-form__item-block">
                    ...
                    <div class="l-grid">
                        ...
                        <br/>
                        <div class="c-form__item-style is-large">
                            <select class="c-form__item" name="organization">
                        ...
                        <!--<img class="c-form__user-img" src="./images/user.svg">-->
