        ...
        <div class="c-find">
            <div class="l-row">
                <div class="c-find__item col-1-4" name="pets">
                    <img class="c-find__image" src="/resources/found/images/pets1.jpg">
                ...
                <div class="c-find__item col-1-4" name="pets">
                    <img class="c-find__image" src="/resources/found/images/pets2.jpg">
                    <div class="c-find__info">
                        <h4 class="c-find__name">Гоша</h4>
                        <hr class="c-find__line">
                        <img class="c-find__date-image" src="/resources/found/images/date.svg">
                ...
                <div class="c-find__item col-1-4" name="pets">
                    <img class="c-find__image" src="/resources/found/images/pets3.jpg">
                    <div class="c-find__info">
                        <h4 class="c-find__name">Гоша</h4>
                        <hr class="c-find__line">
                        <img class="c-find__date-image" src="/resources/found/images/date.svg">
                ...
                <div class="c-find__item col-1-4" name="pets">
                    <img class="c-find__image" src="/resources/found/images/pets4.jpg">
                    <div class="c-find__info">
                        <h4 class="c-find__name">Гоша</h4>
                        <hr class="c-find__line">
                        <img class="c-find__date-image" src="/resources/found/images/date.svg">
            ...
            <div class="l-row">
                <div class="c-find__item col-1-4" name="pets">
                    <img class="c-find__image" src="/resources/found/images/pets5.jpg">
                    <div class="c-find__info">
                        <h4 class="c-find__name">Гоша</h4>
                        <hr class="c-find__line">
                        <img class="c-find__date-image" src="/resources/found/images/date.svg">
                ...
                <div class="c-find__item col-1-4" name="pets">
                    <img class="c-find__image" src="/resources/found/images/pets6.jpg">
                    <div class="c-find__info">
                        <h4 class="c-find__name">Гоша</h4>
                        <hr class="c-find__line">
                        <img class="c-find__date-image" src="/resources/found/images/date.svg">
                ...
                <div class="c-find__item col-1-4" name="pets">
                    <img class="c-find__image" src="/resources/found/images/pets7.jpg">
                    <div class="c-find__info">
                        <h4 class="c-find__name">Гоша</h4>
                        <hr class="c-find__line">
                        <img class="c-find__date-image" src="/resources/found/images/date.svg">
                ...
                <div class="c-find__item col-1-4" name="pets">
                    <img class="c-find__image" src="/resources/found/images/pets8.jpg">
                    <div class="c-find__info">
...
<div class="c-show-pets">
    ...
    <div class="c-show-pets__main">
        <div class="c-show-pets__photo col-1-4">
            <img class="c-show-pets__main-photo" src="/resources/found/images/pets8.jpg"><br>
