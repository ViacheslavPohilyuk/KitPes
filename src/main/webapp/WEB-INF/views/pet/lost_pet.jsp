...
<script>
    var app = angular.module("PetsLostList", []);
    ...
    app.controller("PetList", function ($scope, $http) {
        ...
        function requestItems() {
            ...
            $http({
                method: 'GET',
                url: '/api/foundlostpets/limited?type=0&bunch=' + ${page}
...
<body class="c-body" ng-app="PetsLostList" ng-controller="PetList">
<div class="l-main">
    ...
    <h2 class="c-head">База потерянных питомцев</h2>
...
<div>
    <div class="pagination">
        <c:if test="${page != 0}">
            <a class="prev_page_button" href="/foundLostPet/lost/${page - 1}" style="display: inline-block;">
                <i class="fa fa-arrow-circle-left" aria-hidden="true"></i>
            </a>
        </c:if>
        <c:if test="${((page + 1) * bunch) < count}">
            <a class="prev_page_button" href="/foundLostPet/lost/${page + 1}">
...
<!-- file="/resources/lost/js/feed.js" file="/resources/lost/js/js.js"-->
