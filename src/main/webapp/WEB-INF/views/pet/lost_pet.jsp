...
<head>
    <meta charset="UTF-8">
    <title>Kitpes - base lose pets</title>
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/assets/style.css"/>">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/lost/styles/main.css"/>">
</head>
<div class="c-body">
    <div class="l-main">
        ...
        <h2 class="c-head">База пропавших питомцев</h2>
        ...
        <div class="l-layot">
            <div class="c-find">
                <div class="l-row">
                    <div class="c-find__item col-1-4" name="pets">
                        <img class="c-find__image" src="/resources/lost/images/pets1.jpg">
                        <div class="c-find__info">
                            <h4 class="c-find__name">Гоша</h4>
                            <hr class="c-find__line">
                            <img class="c-find__date-image" src="/resources/lost/images/date.svg">
                            <span class="c-find__date">15.10.2017</span>
                            <img class="c-find__user-image" src="/resources/lost/images/user.svg">
                            <span class="c-find__user">Максимов Вениамин</span>
                        </div>
                        <div class="c-find__learn-more">
                            <img class="c-find__plus" src="/resources/lost/images/plus.png">
                            <a class="c-find__link" href="#"><span class="c-find__link-text">Узнать больше</span></a>
                        </div>
                    </div>
                    <div class="c-find__item col-1-4" name="pets">
                        <img class="c-find__image" src="/resources/lost/images/pets2.jpg">
                        <div class="c-find__info">
                            <h4 class="c-find__name">Гоша</h4>
                            <hr class="c-find__line">
                            <img class="c-find__date-image" src="/resources/lost/images/date.svg">
                    ...
                    <div class="c-find__item col-1-4" name="pets">
                        <img class="c-find__image" src="/resources/lost/images/pets3.jpg">
                        <div class="c-find__info">
                            <h4 class="c-find__name">Гоша</h4>
                            <hr class="c-find__line">
                            <img class="c-find__date-image" src="/resources/lost/images/date.svg">
                    ...
                    <div class="c-find__item col-1-4" name="pets">
                        <img class="c-find__image" src="/resources/lost/images/pets4.jpg">
                        <div class="c-find__info">
                            <h4 class="c-find__name">Гоша</h4>
                            <hr class="c-find__line">
                            <img class="c-find__date-image" src="/resources/lost/images/date.svg">
                ...
                <div class="l-row">
                    <div class="c-find__item col-1-4" name="pets">
                        <img class="c-find__image" src="/resources/lost/images/pets5.jpg">
                        <div class="c-find__info">
                            <h4 class="c-find__name">Гоша</h4>
                            <hr class="c-find__line">
                            <img class="c-find__date-image" src="/resources/lost/images/date.svg">
                            <span class="c-find__date">15.10.2017</span>
                            <img class="c-find__user-image" src="/resources/lost/images/user.svg">
                            <span class="c-find__user" href="#">Максимов Вениамин</span>
                        </div>
                        <div class="c-find__learn-more">
                            <img class="c-find__plus" src="/resources/lost/images/plus.png">
                            <a class="c-find__link" href="#"><span class="c-find__link-text">Узнать больше</span></a>
                    ...
                    <div class="c-find__item col-1-4" name="pets">
                        <img class="c-find__image" src="/resources/lost/images/pets6.jpg">
                        <div class="c-find__info">
                            <h4 class="c-find__name">Гоша</h4>
                            <hr class="c-find__line">
                            <img class="c-find__date-image" src="/resources/lost/images/date.svg">
                    ...
                    <div class="c-find__item col-1-4" name="pets">
                        <img class="c-find__image" src="/resources/lost/images/pets7.jpg">
                        <div class="c-find__info">
                            <h4 class="c-find__name">Гоша</h4>
                            <hr class="c-find__line">
                            <img class="c-find__date-image" src="/resources/lost/images/date.svg">
                    ...
                    <div class="c-find__item col-1-4" name="pets">
                        <img class="c-find__image" src="/resources/lost/images/pets8.jpg">
                        <div class="c-find__info">
                            <h4 class="c-find__name">Люси</h4>
                            <hr class="c-find__line">
                            <img class="c-find__date-image" src="/resources/lost/images/date.svg">
                            <span class="c-find__date">15.10.2017</span>
                            <img class="c-find__user-image" src="/resources/lost/images/user.svg">
                        ...
                        <div class="c-find__learn-more" onclick="show('block')">
                            <img class="c-find__plus" src="/resources/lost/images/plus.png">
                            <a class="c-find__link" href="#"><span class="c-find__link-text">Узнать больше</span></a>
                        </div>
                    </div>
            ...
            <div class="l-row">
                <div class="c-find__item is-hidden" name="pets">
                    <img class="c-find__image" src="/resources/lost/images/pets1.jpg">
                    <div class="c-find__info">
                        <h4 class="c-find__name">Гоша</h4>
                        <hr class="c-find__line">
        ...
        <div class="l-layot">
            <div class="c-find__show-all">
                <div class="l-grid">
                    <h4 class="c-find__show-all-head">показать всех пропавших питомцев</h4>
                    <img class="c-find__down" src="/resources/lost/images/down.svg">
                </div>
            </div>
        </div>
    ...
    <div class="l-show-pets" onclick="show(" block
    ")">
    <div class="c-show-pets">
        <div class="c-show-pets__name" name="name">Люси</div>
        <button class="c-show-pets__close" onclick="show('none')"></button>
        <div class="c-show-pets__main">
            <div class="c-show-pets__photo col-1-4">
                <img class="c-show-pets__main-photo" src="/resources/lost/images/pets8.jpg"><br>
                <span class="c-show-pets__search">
                <img class="c-show-pets__view" src="/resources/lost/images/view.png">
                <span class="c-show-pets__show-all-photo">просмотреть все фото</span>
            </span><br>
                <div class="l-flex">
                    <img class="c-show-pets__small-photo" src="/resources/lost/images/pets8.jpg">
                    <img class="c-show-pets__small-photo" src="/resources/lost/images/pets9.jpg">
                    <img class="c-show-pets__small-photo" src="/resources/lost/images/pets10.jpg">
                    <img class="c-show-pets__small-photo" src="/resources/lost/images/pets11.jpg">
                </div>
            </div>
            <div class="c-show-pets__info col-3-4">
                ...
                <span class="c-show-pets__type" name="age">2 года</span>/
                ...
                <div class="c-show-pets__description">Тонкинская кошка - гибрид сиамской и бирманской кошки
                    американского
                    типа. Внешне тонкинская кошка - нечто среднее между её предками: очертания более округлы, чем у
                    сиамской,
                    вес и ширина меньше чем у бирманской.
                </div>
            </div>
        </div>
        <div class="c-show-pets__contacts col-2-3">
            <span class="c-show-pets__contacts-head">Контакты человека, нашедего питомца</span><br>
            <img class="c-show-pets__user-image" src="/resources/lost/images/user.svg">
            <span class="c-show-pets__finder" name="finder">Максим Вениаминов</span>
            <a class="c-show-pets__socials" href="#" name="instagram">
                <img class="c-show-pets__socials-img" src="/resources/lost/images/instagram.png">
            </a>
            <a class="c-show-pets__socials" href="#" name="facebook">
                <img class="c-show-pets__socials-img" src="/resources/lost/images/facebook.png">
            </a>
            <a class="c-show-pets__socials" href="#" name="twitter">
                <img class="c-show-pets__socials-img" src="/resources/lost/images/twitter.png">
            </a>
            <a class="c-show-pets__socials" href="#" name="google+">
                <img class="c-show-pets__socials-img" src="/resources/lost/images/google.png">
            </a>
            <button class="c-show-pets__massage" name="newmassage">
                <img class="c-show-pets__massage-img" src="/resources/lost/images/massage.png">отправить сообщение
            </button>
            <hr class="c-show-pets__line">
            <div class="c-show-pets__contact-item">
                <img class="c-show-pets__contact-img" src="/resources/lost/images/phone.png">
                <span class="c-show-pets__contact">телефон</span><br>
                <span class="c-show-pets__telephon" name="telephone">+38 063 99 51 611</span>
            </div>
            <div class="c-show-pets__contact-item">
                <img class="c-show-pets__contact-img" src="/resources/lost/images/mail.png">
                <span class="c-show-pets__contact">почта</span><br>
                <span class="c-show-pets__email" name="email">benmax@gmai1.com</span>
            </div>
            <div class="c-show-pets__contact-item">
                <img class="c-show-pets__contact-img" src="/resources/lost/images/marker.png">
                <span class="c-show-pets__contact">адрес:</span><br>
                <span class="c-show-pets__address" name="address">ул. Парус 2</span>
            </div>
        </div>
        <button class="c-show-pets__button">Я нашел этого питомца!</button>
    </div>
</div>
</div>
</div>
...
<script type="text/javascript">
    ...
    <%@include file="/resources/lost/js/js.js"%>
</script>
</body>
</html>
